...
function Hero() {
  return (
    <div className='h-screen w-full rounded-md flex flex-col items-center justify-center
    relative overflow-hidden mx-auto py-10 md:py-0'>
      ...
      <div className='p-4 relative z-10 w-full text-center'>
        ...
        <h1 
        className="mt-20 md:mt-0 text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400"
